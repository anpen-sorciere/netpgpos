...
require_once __DIR__ . '/../classes/base_scope_manager.php';
...
echo "<h2>管理機能</h2>";
echo '<a href="../setup/clear_session.php" style="background: #6c757d; color: white; padding: 5px 10px; text-decoration: none; border-radius: 3px;">セッションクリア</a><br>';
