...
try {
    ...
    try {
        ...
        try {
            ...
            // Sync失敗してもメイン処理は続行
            error_log("order_monitor.php: Sync DB Connection Failed: " . $e->getMessage());
        }
...
// ★ キャストポータル用データ同期関数（order_data_ajax.phpと同じロジック）
function syncOrdersToDbForMonitor($pdo, $orders, $manager = null) {
